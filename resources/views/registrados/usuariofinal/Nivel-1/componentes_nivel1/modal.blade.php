...
<section class="modal" id="modal">
    <div class="modal_cont">
        ...
        <div class="cont_imagenes_modal">            
            <img src="{{ asset('imgs/nivel2/imagen_1.jpeg') }}" class="respuesta" id="imagen1" alt="Respuesta 1" data-id="0">
            <img src="{{ asset('imgs/nivel2/imagen_1.jpeg') }}" class="respuesta" id="imagen2" alt="Respuesta 2" data-id="1">
            <img src="{{ asset('imgs/nivel2/imagen_1.jpeg') }}" class="respuesta" id="imagen3" alt="Respuesta 3" data-id="2">
