...
<div id="desplegableInstrucciones" class="desplegable">
    <div class="contenido-desplegable" id="modal_contenidoo">
        <div class="encabezado-desplegable">
            <h5 class="titulo-desplegable">{{_('Instrucciones:')}}</h5>
        ...
        <div class="pie-desplegable">
            <button id="botonSiguienteInstruccion" class="boton-cerrar" onclick="cambiarImagen()">{{_('¡Entendido!')}}</button>
            <button id="botonVamos" class="boton-cerrar" onclick="cerrarDesplegable()" style="display: none;">{{_('¡Vamos!')}}</button>
        </div>
    </div>
</div>
