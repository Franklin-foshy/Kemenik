...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateCorrectAnswers(count) {
        if (count === 1) {
            // Número mínimo de respuestas correctas para desbloquear Nivel 2
    ...
    // consultas de los niveles bloqueo
    let apiUrl = `${Rute}://${dominio}/api/progreso-dos-usuario/${window.userId}`;
    let estado_nivel2 = 0;
    ...
    let apiUrl1 = `${Rute}://${dominio}/api/progreso-usuario/${window.userId}`;
    let estado_nivel1 = 0;
